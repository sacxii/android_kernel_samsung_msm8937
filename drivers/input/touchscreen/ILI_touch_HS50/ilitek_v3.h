...
#define DEBUG_DATA_FILE_PATH		"/sdcard/tpdata/ILITEK_log.csv"
...
extern int ili_get_array_size(void);
...
#define ILI_POWER_SOURCE_CUST_EN  1
...
extern int ili_lcm_bias_power_init(struct ilitek_ts_data *idev);
extern int ili_lcm_bias_power_deinit(struct ilitek_ts_data *idev);
extern int ili_lcm_power_source_ctrl(struct ilitek_ts_data *idev, int enable);
